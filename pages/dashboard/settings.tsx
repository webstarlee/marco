            ...
            <Popover className="flex h-16 justify-between">
              ...
              <Transition.Root as={Fragment}>
                <div className="lg:hidden">
                  ...
                  >
                    <Popover.Overlay
                      className="bg-black fixed inset-0 z-20 bg-opacity-25"
                      aria-hidden="true"
                    />
                  </Transition.Child>
                  ...
                  >
                    ...
                    >
                      <div className="ring-black divide-y divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-opacity-5">
